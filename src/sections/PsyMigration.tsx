...
const PsyMigration = () => {
  ...
  const challenges = [
    {
      icon: Plane,
      title: uk ? 'Стрес еміграції' : 'Стресс эмиграции',
      description: uk
        ? 'Емоційна ціна прощання зі звичним світом: дім, робота, люди.'
        : 'Эмоциональная цена расставания с привычным миром: дом, работа, люди.'
    },
    {
      icon: Users,
      title: uk ? 'Втрата опори' : 'Потеря опоры',
      description: uk
        ? 'Відстань від близьких, від звичної системи підтримки та розуміння.'
        : 'Расстояние от близких, от привычной системы поддержки и понимания.'
    },
    {
      icon: Home,
      title: uk ? 'Складнощі адаптації' : 'Сложности адаптации',
      description: uk
        ? 'Нова культура, мовний бар’єр, відчуття чужості та неприналежності.'
        : 'Новая культура, языковой барьер, чувство чуждости и непринадлежности.'
    },
    {
      icon: Globe,
      title: uk ? 'Питання ідентичності' : 'Вопросы идентичности',
      description: uk
        ? 'Хто я в цьому новому місці? Як поєднати минуле з теперішнім?'
        : 'Кто я в этом новом месте? Как соединить прошлое с настоящим?'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <p className="text-[#A3B18A] text-sm uppercase tracking-widest mb-4 font-medium">
              {uk ? 'Для емігрантів' : 'Для эмигрантов'}
            </p>
            <h2 className="text-[#2B2B2B] text-2xl sm:text-3xl lg:text-4xl mb-6">
              {uk ? 'Розумію досвід переїзду' : 'Понимаю опыт переезда'}
            </h2>
            <p className="text-[#5A5A5A] mb-8">
              {uk
                ? 'Як психолог, який працює з емігрантами, я добре розумію особливі виклики, з якими ви стикаєтесь. Переїзд до іншої країни — це не лише логістика, а й глибока емоційна подорож.'
          ...
          >
            ...
            >
              <p className="text-[#2B2B2B] italic text-sm">
                {uk
                  ? '«Вам не потрібно проходити цей шлях наодинці. Я поруч, щоб допомогти знайти опору в новому світі.»'
